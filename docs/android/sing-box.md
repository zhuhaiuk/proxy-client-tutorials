...
![sing-box 软件图标截图](../../assets/images/tutorial/27.png)

### 主界面预览

下图是 sing-box 的主界面或初始界面，后续步骤会从这里开始操作。

![sing-box 主界面预览截图](../../assets/images/tutorial/28.png)
...
![sing-box 打开 Profiles截图](../../assets/images/tutorial/29.png)

### 2. 选择手动创建

在导入方式中选择 Create Manually。

![sing-box 选择手动创建截图](../../assets/images/tutorial/30.png)

### 3. 进入编辑页

进入配置编辑页面后，准备填写远程订阅信息。

![sing-box 进入编辑页截图](../../assets/images/tutorial/31.png)

### 4. 切换 Remote

将 Type 改为 Remote，在 URL 粘贴订阅链接，Name 填写便于识别的名称。

![sing-box 切换 Remote截图](../../assets/images/tutorial/32.png)

### 5. 确认配置下载

保存后确认订阅配置已经出现在列表中。

![sing-box 确认配置下载截图](../../assets/images/tutorial/33.png)

### 6. 开启订阅

点击右下角按钮启用当前配置。

![sing-box 开启订阅截图](../../assets/images/tutorial/34.png)

### 7. 测试并选择节点

进入 Groups，点击闪电按钮测试延迟，选择有延迟的节点。

![sing-box 测试并选择节点截图](../../assets/images/tutorial/35.png)
